...
public class UserSignController {
    ...
    public ResponseEntity<Void> validEmail(@RequestBody String email) throws DuplicateDataException {
    ...
    public ResponseEntity<Integer> validPhoneForSignUp(@RequestParam String phoneNo) throws SMSException, DuplicateDataException {
