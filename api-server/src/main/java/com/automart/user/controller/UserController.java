...
public class UserController {
    ...
    public ResponseEntity<String> singIn(@RequestParam String email, @RequestParam String password) throws SigninFailedException {
     ...
     * 이메일로 특정 회원 조회
     */
    public ResponseEntity<UserResponseDto> showUser(@RequestParam String email) {
